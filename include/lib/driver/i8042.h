...
static u_int32 i8042_noaux;
static u_int32 i8042_nomux;
static u_int32 i8042_unlock;
static u_int32 i8042_reset;
static u_int32 i8042_direct;
static u_int32 i8042_dumbkbd;
static u_int32 i8042_noloop;
static u_int32 i8042_blink_frequency = 500;
...
{
	return asm_::inb(I8042_DATA_REG);
}

static inline int i8042_read_status(void)
{
	return asm_::inb(I8042_STATUS_REG);
}

static inline void i8042_write_data(int val)
{
	asm_::outb(I8042_DATA_REG, val);
}

static inline void i8042_write_command(int val)
{
	asm_::outb(I8042_COMMAND_REG, val);
}
